...
(function($PS) {
  ...
  var errToString = function (v) {
      ...
      throw new Error("Failed pattern match at HarborView.Common (line 22, column 1 - line 22, column 41): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var Sell = (function () {
      function Sell(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Sell.create = function (value0) {
          return function (value1) {
              return new Sell(value0, value1);
          };
      };
      return Sell;
  })();
  ...
  var render = function (state) {
      var purchaseTable = (function () {
          var rows = Data_Functor.map(Data_Functor.functorArray)(toRow)(state.purchases);
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-elm" ]) ])([ HarborView_UI.mkButton("Fetch paper purchases")(FetchPaper.create), HarborView_UI.mkButton("Fetch real purchases")(FetchReal.create) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-elm" ]) ])([ purchaseTable ]) ]);
  };
          ...
          return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(url))(function (res) {
              var result = (function () {
                  ...
                  if (res instanceof Data_Either.Right) {
                      var initData = purchasesFromJson(res.value0.body);
                      if (initData instanceof Data_Either.Left) {
                          return Data_Either.Left.create(new HarborView_Common.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(initData.value0)));
                      };
                      if (initData instanceof Data_Either.Right) {
                          return new Data_Either.Right(initData.value0);
                      };
                      throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 132, column 15 - line 136, column 34): " + [ initData.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 125, column 11 - line 136, column 34): " + [ res.constructor.name ]);
              })();
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(result);
          }));
      };
      ...
      return function (v) {
          ...
          if (v instanceof FetchReal) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $19.purchases = [  ];
                  $19.header = "Real purchases";
                  return $19;
              }));
          };
          if (v instanceof FetchPaper) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(fetchPurchases(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(true)))(function (result) {
                  if (result instanceof Data_Either.Left) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $24.msg = "Fetch purchases FAIL: " + HarborView_Common.errToString(result.value0);
                          return $24;
                      });
                  };
                  if (result instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $28.msg = "Fetch purchases";
                          $28.header = "Paper purchases";
                          $28.purchases = result.value0;
                          return $28;
                      });
                  };
                  throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 214, column 7 - line 221, column 32): " + [ result.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 204, column 16 - line 221, column 32): " + [ v.constructor.name ]);
      };
  };
