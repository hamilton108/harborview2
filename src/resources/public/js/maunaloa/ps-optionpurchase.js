...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["HarborView.Common"] = $PS["HarborView.Common"] || {};
  var exports = $PS["HarborView.Common"];
  var Data_Either = $PS["Data.Either"];
  ...
  var numToString = function (num) {
      return Data_Number_Format.toStringWith(Data_Number_Format.fixed(2))(num);
  };
  var errToString = function (v) {
      ...
      throw new Error("Failed pattern match at HarborView.Common (line 37, column 1 - line 37, column 41): " + [ v.constructor.name ]);
  };
  var jsonResultToString = function (result) {
      if (result instanceof Data_Either.Left) {
          return errToString(result.value0);
      };
      if (result instanceof Data_Either.Right) {
          return result.value0.msg;
      };
      throw new Error("Failed pattern match at HarborView.Common (line 55, column 3 - line 59, column 18): " + [ result.constructor.name ]);
  };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["HarborView.UI"] = $PS["HarborView.UI"] || {};
  var exports = $PS["HarborView.UI"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Events = $PS["Halogen.HTML.Events"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var InputVal = function (x) {
      return x;
  };
  var mkInput_ = function (inpType) {
      return function (evt) {
          return function (val) {
              ...
              throw new Error("Failed pattern match at HarborView.UI (line 78, column 3 - line 95, column 10): " + [ val.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["HarborView.ModalDialog"] = $PS["HarborView.ModalDialog"] || {};
  var exports = $PS["HarborView.ModalDialog"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var HarborView_UI = $PS["HarborView.UI"];                
  ...
  var dlgStateToClass = function (v) {
      ...
      throw new Error("Failed pattern match at HarborView.ModalDialog (line 28, column 1 - line 28, column 44): " + [ v.constructor.name ]);
  };
  var modalDialog = function (v) {
      return function (dlgState) {
          return function (ok) {
              return function (cancel) {
                  return function (content) {
                      var headerDiv = Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text(v) ]);
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "modalDialog", dlgStateToClass(dlgState) ]) ])([ Halogen_HTML_Elements.div_([ headerDiv, content, HarborView_UI.mkButton("OK")(ok), HarborView_UI.mkButton("Cancel")(cancel) ]) ]);
                  };
              };
          };
      };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["HarborView.Util.HttpUtil"] = $PS["HarborView.Util.HttpUtil"] || {};
  var exports = $PS["HarborView.Util.HttpUtil"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  var HarborView_Common = $PS["HarborView.Common"];                
  var postAff = function (dictMonadAff) {
      return function (v) {
          return function (requestBody) {
              return function (f) {
                  return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.post(Affjax_ResponseFormat.json)(v)(new Data_Maybe.Just(requestBody)))(function (res) {
                      var result = (function () {
                          if (res instanceof Data_Either.Left) {
                              return Data_Either.Left.create(new HarborView_Common.AffjaxError(Affjax.printError(res.value0)));
                          };
                          if (res instanceof Data_Either.Right) {
                              var fresult = f(res.value0.body);
                              if (fresult instanceof Data_Either.Left) {
                                  return Data_Either.Left.create(new HarborView_Common.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(fresult.value0)));
                              };
                              if (fresult instanceof Data_Either.Right) {
                                  return new Data_Either.Right(fresult.value0);
                              };
                              throw new Error("Failed pattern match at HarborView.Util.HttpUtil (line 63, column 15 - line 67, column 33): " + [ fresult.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at HarborView.Util.HttpUtil (line 56, column 11 - line 67, column 33): " + [ res.constructor.name ]);
                      })();
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(result);
                  }));
              };
  ...
  var getAff = function (dictMonadAff) {
      return function (v) {
          return function (f) {
              return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(v))(function (res) {
                  var result = (function () {
                      if (res instanceof Data_Either.Left) {
                          return Data_Either.Left.create(new HarborView_Common.AffjaxError(Affjax.printError(res.value0)));
                      };
                      if (res instanceof Data_Either.Right) {
                          ...
                          throw new Error("Failed pattern match at HarborView.Util.HttpUtil (line 36, column 15 - line 40, column 33): " + [ fresult.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at HarborView.Util.HttpUtil (line 29, column 11 - line 40, column 33): " + [ res.constructor.name ]);
                  })();
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(result);
              }));
          };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["HarborView.OptionPurchase.Core"] = $PS["HarborView.OptionPurchase.Core"] || {};
  var exports = $PS["HarborView.OptionPurchase.Core"];
  var Affjax_RequestBody = $PS["Affjax.RequestBody"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var HarborView_Common = $PS["HarborView.Common"];
  var HarborView_ModalDialog = $PS["HarborView.ModalDialog"];
  var HarborView_UI = $PS["HarborView.UI"];
  var HarborView_Util_HttpUtil = $PS["HarborView.Util.HttpUtil"];
  var Web_Event_Event = $PS["Web.Event.Event"];
  ...
  var SellAmount = (function () {
      ...
      SellAmount.value = new SellAmount();
      return SellAmount;
  })();
  var SellPrice = (function () {
      ...
      SellPrice.value = new SellPrice();
      return SellPrice;
  })();
  var FetchPaper = (function () {
      function FetchPaper(value0) {
          this.value0 = value0;
      };
      FetchPaper.create = function (value0) {
          return new FetchPaper(value0);
      };
      return FetchPaper;
  })();
  var FetchReal = (function () {
      function FetchReal(value0) {
          this.value0 = value0;
      };
      FetchReal.create = function (value0) {
          return new FetchReal(value0);
      };
      return FetchReal;
  })();
  var SellDlgShow = (function () {
      function SellDlgShow(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SellDlgShow.create = function (value0) {
          return function (value1) {
              return new SellDlgShow(value0, value1);
          };
      };
      return SellDlgShow;
  })();
  var SellDlgOk = (function () {
      function SellDlgOk(value0) {
          this.value0 = value0;
      };
      SellDlgOk.create = function (value0) {
          return new SellDlgOk(value0);
      };
      return SellDlgOk;
  })();
  var SellDlgCancel = (function () {
      function SellDlgCancel(value0) {
          this.value0 = value0;
      };
      SellDlgCancel.create = function (value0) {
          return new SellDlgCancel(value0);
      };
      return SellDlgCancel;
  })();
  ...
  var toRow = function (p) {
      var svol = Data_Number_Format.toString(Data_Int.toNumber(p.svol));
      var spot = HarborView_Common.numToString(p.spot);
      var pvol = Data_Number_Format.toString(Data_Int.toNumber(p.pvol));
      var price = HarborView_Common.numToString(p.price);
      var oid = Data_Number_Format.toString(Data_Int.toNumber(p.oid));
      var days = Data_Number_Format.toString(Data_Int.toNumber(p.days));
      var bid = HarborView_Common.numToString(p.bid);
      return Halogen_HTML_Elements.tr_([ HarborView_UI.mkButton("Sell")(SellDlgShow.create(p)), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(oid) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(p.stock) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(p.ot) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(p.ticker) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(p.pdate) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(p.exp) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(days) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(price) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(bid) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(spot) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(pvol) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(svol) ]) ]);
  };
  var tableHeader = Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Sell") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Oid") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Stock") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Option Type") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Ticker") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Purchase Date") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Expiry") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Days") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Purchase Price") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Bid") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Spot") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Purchase vol.") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Sales vol.") ]) ]) ]);
  var sellParams = function (price) {
      return function (amount) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Int.fromString(amount))(function (a) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Number.fromString(price))(function (p) {
  ...
  var resultFromJson = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
  ...
  var sell = function (dictMonadAff) {
      return function (v) {
          return function (v1) {
              return function (v2) {
                  var payload = Affjax_RequestBody.json(Data_Argonaut_Core.fromArray([ Data_Argonaut_Core.jsonSingletonObject("oid")(Data_Argonaut_Core.fromNumber(Data_Int.toNumber(v))), Data_Argonaut_Core.jsonSingletonObject("price")(Data_Argonaut_Core.fromNumber(v1)), Data_Argonaut_Core.jsonSingletonObject("amt")(Data_Argonaut_Core.fromNumber(Data_Int.toNumber(v2))) ]));
                  return HarborView_Util_HttpUtil.postAff(dictMonadAff)("/maunaloa/stockoption/sell")(payload)(resultFromJson);
              };
          };
      };
  };
  var sell_ = function (dictMonadAff) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                  return v.sellAmount;
              }))(function (sellAmount1) {
                  if (sp1 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $30.dlgSell = HarborView_ModalDialog.DialogHidden.value;
                          $30.msg = "No purchase selected";
                          return $30;
                      });
                  };
                  if (sp1 instanceof Data_Maybe.Just) {
                      var v = sellParams(sellPrice1)(sellAmount1);
                      if (v instanceof Data_Maybe.Nothing) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              var $34 = {};
                              for (var $35 in st) {
                              ...
                              $34.sp = Data_Maybe.Nothing.value;
                              $34.dlgSell = HarborView_ModalDialog.DialogHidden.value;
                              $34.msg = "Wrong format sell price/amount";
                              return $34;
                          });
                      };
                      if (v instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(sell(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(sp1.value0.oid)(v.value0.price)(v.value0.amt))(function (result) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $37 = {};
                                  for (var $38 in st) {
                                  ...
                                  $37.sp = Data_Maybe.Nothing.value;
                                  $37.dlgSell = HarborView_ModalDialog.DialogHidden.value;
                                  $37.msg = HarborView_Common.jsonResultToString(result);
                                  return $37;
                              });
                          });
                      };
                      throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 322, column 7 - line 335, column 20): " + [ v.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 315, column 3 - line 335, column 20): " + [ sp1.constructor.name ]);
              });
          });
      });
  };
  var purchasesFromJson = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
      reflectSymbol: function () {
          return "ticker";
      }
  })()())({
  ...
  var prevDefault = function (dictMonadEffect) {
      return function (evt) {
          return Effect_Class.liftEffect(dictMonadEffect)(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(evt)));
      };
  };
  var mkSellDialog = function (dlgState) {
      return function (prm) {
          var prmx = (function () {
              if (prm instanceof Data_Maybe.Nothing) {
                  return {
                      h: "",
                      inp: "0.0"
                  };
              };
              if (prm instanceof Data_Maybe.Just) {
                  return {
                      h: "Option purchase for " + prm.value0.ticker,
                      inp: HarborView_UI.InputVal(HarborView_Common.numToString(prm.value0.bid))
                  };
              };
              throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 255, column 7 - line 261, column 22): " + [ prm.constructor.name ]);
          })();
          var price = HarborView_UI.mkInput("Price")(DOM_HTML_Indexed_InputType.InputNumber.value)(ValueChanged.create(SellPrice.value))(new Data_Maybe.Just(prmx.inp));
          var amt = HarborView_UI.mkInput("Amount")(DOM_HTML_Indexed_InputType.InputNumber.value)(ValueChanged.create(SellAmount.value))(Data_Maybe.Nothing.value);
          var content = Halogen_HTML_Elements.div_([ amt, price ]);
          return HarborView_ModalDialog.modalDialog(prmx.h)(dlgState)(SellDlgOk.create)(SellDlgCancel.create)(content);
      };
  };
  var render = function (st) {
      var purchaseTable = (function () {
          var rows = Data_Functor.map(Data_Functor.functorArray)(toRow)(st.purchases);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])([ Halogen_HTML_Elements.table([ Halogen_HTML_Properties.classes([ "table", "table-hoover" ]) ])([ tableHeader, Halogen_HTML_Elements.tbody_(rows) ]) ]);
      })();
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-elm" ]) ])([ HarborView_UI.mkButton("Fetch paper purchases")(FetchPaper.create), HarborView_UI.mkButton("Fetch real purchases")(FetchReal.create), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(st.header) ]), Halogen_HTML_Core.text(st.msg) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-elm" ]) ])([ purchaseTable, mkSellDialog(st.dlgSell)(st.sp) ]) ]);
  };
  var mkHeader = function (isPaper) {
      var $44 = isPaper === true;
      if ($44) {
          return "Paper purchases.";
      };
      return "Real purchases.";
  };
  var fetchPurchases = function (dictMonadAff) {
      return function (isPaper) {
          var url = (function () {
              var $45 = isPaper === false;
              if ($45) {
                  return "/maunaloa/stoc|koption/purchases/3";
              };
              return "/maunaloa/stockoption/purchases/11";
          })();
          return HarborView_Util_HttpUtil.getAff(dictMonadAff)(url)(purchasesFromJson);
      };
  };
  var fetchPurchases_ = function (dictMonadAff) {
      return function (isPaper) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(fetchPurchases(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(isPaper))(function (result) {
              if (result instanceof Data_Either.Left) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $47 = {};
                      for (var $48 in st) {
                      ...
                      $47.header = mkHeader(isPaper);
                      $47.purchases = [  ];
                      $47.msg = " Fetch purchases FAIL: " + HarborView_Common.errToString(result.value0);
                      return $47;
                  });
              };
              if (result instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $51.header = mkHeader(isPaper);
                      $51.purchases = result.value0;
                      $51.msg = " Fetch purchases Ok";
                      return $51;
                  });
              };
              throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 287, column 5 - line 297, column 30): " + [ result.constructor.name ]);
          });
      };
  };
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof FetchReal) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value0))(fetchPurchases_(dictMonadAff)(false));
          };
          if (v instanceof FetchPaper) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value0))(fetchPurchases_(dictMonadAff)(true));
          };
          if (v instanceof SellDlgShow) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value1))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $58 = {};
                  for (var $59 in st) {
                  ...
                  $58.sp = new Data_Maybe.Just(v.value0);
                  $58.dlgSell = HarborView_ModalDialog.DialogVisible.value;
                  $58.sellPrice = HarborView_Common.numToString(v.value0.bid);
                  return $58;
              }));
          };
          if (v instanceof SellDlgOk) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value0))(sell_(dictMonadAff));
          };
          if (v instanceof SellDlgCancel) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $64 = {};
                  for (var $65 in st) {
                  ...
                  $64.sp = Data_Maybe.Nothing.value;
                  $64.dlgSell = HarborView_ModalDialog.DialogHidden.value;
                  $64.msg = "0.0";
                  return $64;
              }));
          };
          if (v instanceof ValueChanged && v.value0 instanceof SellPrice) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $68 = {};
                  for (var $69 in st) {
                  ...
                  $68.sellPrice = v.value1;
                  return $68;
              });
          };
          if (v instanceof ValueChanged && v.value0 instanceof SellAmount) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $73 = {};
                  for (var $74 in st) {
                  ...
                  $73.sellAmount = v.value1;
                  return $73;
              });
          };
          throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 343, column 16 - line 369, column 28): " + [ v.constructor.name ]);
      };
  };
      ...
      return Halogen_Component.mkComponent({
          initialState: function (v) {
              return {
                  ...
                  header: "-",
                  isPaper: true,
                  dlgSell: HarborView_ModalDialog.DialogHidden.value,
                  sp: Data_Maybe.Nothing.value,
                  sellPrice: "0.0",
                  sellAmount: "0.0"
              };
          },
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["OptionPurchaseMain"] = $PS["OptionPurchaseMain"] || {};
  var exports = $PS["OptionPurchaseMain"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var HarborView_OptionPurchase_Core = $PS["HarborView.OptionPurchase.Core"];                
  var run = function (node) {
      return function (qs) {
          if (node instanceof Data_Maybe.Nothing) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(Data_Show.showString)("No such element: " + qs));
          };
          if (node instanceof Data_Maybe.Just) {
              return Control_Apply.applySecond(Effect_Aff.applyAff)(Halogen_VDom_Driver.runUI(HarborView_OptionPurchase_Core.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(node.value0))(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit));
          };
          throw new Error("Failed pattern match at OptionPurchaseMain (line 22, column 3 - line 30, column 20): " + [ node.constructor.name ]);
      };
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Apply.applySecond(Effect_Aff.applyAff)(Halogen_Aff_Util.awaitLoad)(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#ps-main"))(function (node) {
      return run(node)("#ps-main");
  })));
  exports["run"] = run;
  exports["main"] = main;
})(PS);
PS["OptionPurchaseMain"].main();