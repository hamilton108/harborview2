...
(function($PS) {
  ...
  var errToString = function (v) {
      ...
      throw new Error("Failed pattern match at HarborView.Common (line 33, column 1 - line 33, column 41): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var mkSellDialog = function (dlgState) {
      return function (prm) {
          var prmx = (function () {
              ...
              throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 318, column 7 - line 324, column 22): " + [ prm.constructor.name ]);
          })();
  ...
  var render = function (st) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-elm" ]) ])([ HarborView_UI.mkButton("Fetch paper purchases")(FetchPaper.create), HarborView_UI.mkButton("Fetch real purchases")(FetchReal.create), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(st.msg) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid-elm" ]) ])([ purchaseTable, mkSellDialog(st.dlgSell)(st.sp) ]) ]);
  };
  var mkHeader = function (isPaper) {
      return function (msg) {
          var $31 = isPaper === true;
          if ($31) {
              return "Paper purchases. " + msg;
          };
          return "Real purchases. " + msg;
      };
  };
  var getAff = function (dictMonadAff) {
      return function (url) {
          return function (f) {
              return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(url))(function (res) {
                  var result = (function () {
                      ...
                      if (res instanceof Data_Either.Right) {
                          ...
                          throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 161, column 15 - line 165, column 33): " + [ fresult.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 154, column 11 - line 165, column 33): " + [ res.constructor.name ]);
                  })();
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(result);
              }));
          };
  ...
  var fetchPurchases = function (dictMonadAff) {
      return function (isPaper) {
          var url = (function () {
              var $38 = isPaper === false;
              if ($38) {
                  return "/maunaloa/stockoption/purchases/3";
              };
              return "/maunaloa/stockoption/purchases/11";
          })();
          return getAff(dictMonadAff)(url)(purchasesFromJson);
      };
  };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(fetchPurchases(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(isPaper))(function (result) {
              if (result instanceof Data_Either.Left) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $40.msg = mkHeader(isPaper)(" Fetch purchases FAIL: " + HarborView_Common.errToString(result.value0));
                      return $40;
                  });
              };
              if (result instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $44.msg = mkHeader(isPaper)(" Purchases fetched.");
                      $44.purchases = result.value0;
                      return $44;
                  });
              };
              throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 350, column 5 - line 356, column 30): " + [ result.constructor.name ]);
          });
      };
  };
      ...
      return function (v) {
          ...
          if (v instanceof SellDlgShow) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value1))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $51.sp = new Data_Maybe.Just(v.value0);
                  $51.dlgSell = HarborView_ModalDialog.DialogVisible.value;
                  $51.sellPrice = HarborView_Common.numToString(v.value0.bid);
                  return $51;
              }));
          };
          if (v instanceof SellDlgOk) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $56.sp = Data_Maybe.Nothing.value;
                  $56.dlgSell = HarborView_ModalDialog.DialogHidden.value;
                  $56.msg = st.sellPrice;
                  return $56;
              }));
          };
          if (v instanceof SellDlgCancel) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(prevDefault(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $60.sp = Data_Maybe.Nothing.value;
                  $60.dlgSell = HarborView_ModalDialog.DialogHidden.value;
                  $60.msg = "0.0";
                  return $60;
              }));
          };
          ...
          if (v instanceof ValueChanged && v.value0 instanceof SellAmount) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $69.sellAmount = v.value1;
                  return $69;
              });
          };
          throw new Error("Failed pattern match at HarborView.OptionPurchase.Core (line 363, column 16 - line 394, column 28): " + [ v.constructor.name ]);
      };
  };
