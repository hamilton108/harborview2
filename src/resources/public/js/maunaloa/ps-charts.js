...
(function(exports) {
  ...
  exports.onMouseUpImpl = just => nothing => evt => () => {
      var result = nothing;
      const items = _lines.items;
      for (var i = 0; i < items.length; ++i) {
          const curLine = items[i];
...
(function($PS) {
  ...
  var validateMaybe = function (desc) {
      return function (el) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 393, column 5 - line 395, column 28): " + [ el.constructor.name ]);
      };
  };
  ...
  var showLine = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 110, column 1 - line 113, column 57): " + [ v.constructor.name ]);
      }
  };          
  ...
  var onMouseUp = function (evt) {
      return $foreign.onMouseUpImpl(Data_Maybe.Just.create)(Data_Maybe.Nothing.value)(evt);
  };
      ...
      return function (curStockPrice) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(optionPriceURL(ticker)(curStockPrice)))(function (res) {
              ...
              if (res instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 326, column 17 - line 331, column 43): " + [ result.constructor.name ]);
              };
              throw new Error("Failed pattern match at Maunaloa.LevelLine (line 318, column 9 - line 331, column 43): " + [ res.constructor.name ]);
          });
      };
  };
  ...
  var handleMouseEventUpLine = function (vr) {
      return function (line) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 349, column 5 - line 353, column 45): " + [ line.constructor.name ]);
      };
  };
      ...
      return function (ce) {
          return function (evt) {
              return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(Maunaloa_Common.mainURL + "/days/1"))(function (res) {
                  ...
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 267, column 9 - line 274, column 41): " + [ res.constructor.name ]);
              }));
          };
      };
  };
  ...
  var mouseEventUp = function (vruler) {
      return function (evt) {
          return function __do() {
              var line = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(onMouseUp(evt))();
      ...
      return function (vruler) {
          return function (chartLevel) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 428, column 9 - line 442, column 97): " + [ context.constructor.name ]);
              };
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Maunaloa.JsonCharts"] = $PS["Maunaloa.JsonCharts"] || {};
  var exports = $PS["Maunaloa.JsonCharts"];
  var Affjax = $PS["Affjax"];
  var Affjax_ResponseFormat = $PS["Affjax.ResponseFormat"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var fetchCharts = function (ticker) {
      return function (chartType) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(chartUrl(chartType)(ticker)))(function (res) {
              var result = (function () {
                  if (res instanceof Data_Either.Left) {
                      return Data_Either.Left.create(new Maunaloa_MaunaloaError.AffjaxError(Affjax.printError(res.value0)));
                  };
                  if (res instanceof Data_Either.Right) {
                      var charts = chartsFromJson(res.value0.body);
                      if (charts instanceof Data_Either.Left) {
                          return Data_Either.Left.create(new Maunaloa_MaunaloaError.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(charts.value0)));
                      };
...
})(PS["Maunaloa.Repository"] = PS["Maunaloa.Repository"] || {});
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Maunaloa.Repository"] = $PS["Maunaloa.Repository"] || {};
  var exports = $PS["Maunaloa.Repository"];
  var $foreign = $PS["Maunaloa.Repository"];
  var Data_Maybe = $PS["Data.Maybe"];                
  var getJsonResponse = function (key) {
      return $foreign.getJsonResponseImpl(Data_Maybe.Just.create)(Data_Maybe.Nothing.value)(key);
  };
  exports["getJsonResponse"] = getJsonResponse;
  exports["setJsonResponse"] = $foreign.setJsonResponse;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  ...
  var Maunaloa_Common = $PS["Maunaloa.Common"];
  var Maunaloa_JsonCharts = $PS["Maunaloa.JsonCharts"];
  var Maunaloa_LevelLine = $PS["Maunaloa.LevelLine"];
  var Maunaloa_MaunaloaError = $PS["Maunaloa.MaunaloaError"];
  var Maunaloa_Repository = $PS["Maunaloa.Repository"];                
  var tmp = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 95, column 1 - line 95, column 19): " + [ v.constructor.name ]);
  };
          ...
          return function (ticker) {
              return function (dropAmt) {
                  return function (takeAmt) {
                      ...
                      var cachedResponse = Maunaloa_Repository.getJsonResponse(ticker);
                      if (cachedResponse instanceof Data_Maybe.Just) {
                          var collection = Control_Monad_Reader.runReader(Maunaloa_ChartTransform.transform(cachedResponse.value0))(curEnv);
                          return Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(Data_Show.showString)("Fetched response from repository"))(Maunaloa_ChartCollection.paint(collection));
                      };
                      if (cachedResponse instanceof Data_Maybe.Nothing) {
                          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Maunaloa_JsonCharts.fetchCharts(ticker)(curChartType))(function (charts) {
                              if (charts instanceof Data_Either.Left) {
                              ...
                              if (charts instanceof Data_Either.Right) {
                                  ...
                                  return Control_Apply.applySecond(Effect_Aff.applyAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Maunaloa_Repository.setJsonResponse(ticker)(charts.value0)))(Maunaloa_ChartCollection.paintAff(collection));
                              };
                              throw new Error("Failed pattern match at Main (line 79, column 21 - line 87, column 64): " + [ charts.constructor.name ]);
                          }));
                      };
                      throw new Error("Failed pattern match at Main (line 69, column 5 - line 87, column 64): " + [ cachedResponse.constructor.name ]);
                  };
              };
          };
      };
