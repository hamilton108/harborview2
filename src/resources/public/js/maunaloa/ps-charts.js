...
(function($PS) {
  ...
  var handleErrorAff = function (v) {
      if (v instanceof AffjaxError) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Maunaloa_Common.alert("AffjaxError: " + v.value0));
      };
      if (v instanceof JsonError) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Maunaloa_Common.alert("JsonError: " + v.value0));
      };
      throw new Error("Failed pattern match at Maunaloa.MaunaloaError (line 23, column 1 - line 23, column 44): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var showLine = {
      show: function (v) {
          ...
          if (v instanceof RiscLine) {
              ...
              })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Maunaloa_Common.showTicker))(Data_Show.showBoolean))(Data_Show.showNumber)))(v.value0);
          };
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(optionPriceURL(ticker)(curStockPrice)))(function (res) {
              var result = (function () {
                  ...
                  if (res instanceof Data_Either.Right) {
                      var json = updOptionPriceFromJson(res.value0.body);
                      if (json instanceof Data_Either.Left) {
                          return Data_Either.Left.create(new Maunaloa_MaunaloaError.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(json.value0)));
                      };
              ...
              return Effect_Aff.launchAff_((function () {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Control_Apply.applySecond(Effect_Aff.applyAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(showLine)(v1)))(fetchUpdatedOptionPrice(v1.value0.ticker)(sp)))(function (n) {
                      if (n instanceof Data_Either.Left) {
                          return Maunaloa_MaunaloaError.handleErrorAff(n.value0);
                      };
  ...
  var fetchLevelLinesURL = function (v) {
      return Maunaloa_Common.mainURL + ("/risclines/" + v);
  };
  var fetchLevelLines = function (ticker) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(fetchLevelLinesURL(ticker)))(function (res) {
          var result = (function () {
              if (res instanceof Data_Either.Left) {
                  return Data_Either.Left.create(new Maunaloa_MaunaloaError.AffjaxError(Affjax.printError(res.value0)));
              };
              if (res instanceof Data_Either.Right) {
                  var lines = riscLinesFromJson(res.value0.body);
                  if (lines instanceof Data_Either.Left) {
                      return Data_Either.Left.create(new Maunaloa_MaunaloaError.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(lines.value0)));
                  };
  ...
  var addRiscLines = function (vr) {
      return function (lines) {
          ...
          return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(addRiscLine1)(lines);
      };
  };
  var fetchLevelLineButtonClick = function (ticker) {
      return function (vruler) {
          return function (evt) {
              return Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(fetchLevelLines(ticker))(function (lines) {
                  if (lines instanceof Data_Either.Left) {
                      return Maunaloa_MaunaloaError.handleErrorAff(lines.value0);
                  };
                  if (lines instanceof Data_Either.Right) {
...
(function($PS) {
  ...
  var findChartPredicate = function (v) {
      ...
      throw new Error("Failed pattern match at Maunaloa.ChartCollection (line 75, column 1 - line 75, column 41): " + [ v.constructor.name ]);
  };
  var levelLines = function (ticker) {
      return function (charts) {
          ...
          throw new Error("Failed pattern match at Maunaloa.ChartCollection (line 90, column 5 - line 100, column 63): " + [ levelLine.constructor.name ]);
      };
  };
  var paint = function (v) {
