...
(function($PS) {
  ...
  var validateMaybe = function (desc) {
      return function (el) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 291, column 5 - line 293, column 28): " + [ el.constructor.name ]);
      };
  };
  ...
  var mainURL = "http://localhost:8082";            
  var initLines = {
      lines: [  ],
          ...
          return function (vruler) {
              return function (evt) {
                  return function __do() {
                      ...
                      if (selectedLine instanceof Data_Maybe.Nothing) {
                          return Effect_Console.logShow(Data_Show.showString)("No selected line")();
                      };
                      if (selectedLine instanceof Data_Maybe.Just) {
                          return Effect_Console.logShow(Data_Show.showString)("WHAT?")();
                      };
                      throw new Error("Failed pattern match at Maunaloa.LevelLine (line 268, column 9 - line 272, column 32): " + [ selectedLine.constructor.name ]);
                  };
              };
          };
      };
              ...
              return function (vruler) {
                  return function (evt) {
                      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(fetchLevelLinesURL(ticker)))(function (res) {
                          ...
                          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 203, column 9 - line 218, column 18): " + [ res.constructor.name ]);
                      }));
                  };
              };
          };
      ...
      return function (vruler) {
          return function (chartLevel) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 321, column 9 - line 338, column 42): " + [ context.constructor.name ]);
              };
          };
      };
  };
