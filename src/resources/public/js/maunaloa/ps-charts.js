...
(function($PS) {
  ...
  var incMonths = function (v) {
      ...
      throw new Error("Failed pattern match at Maunaloa.ChartTransform (line 246, column 1 - line 246, column 30): " + [ v.constructor.name ]);
  };
  ...
  var transform = function (response) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Data_Identity.monadIdentity)))(function (v) {
          ...
          var ruler = Maunaloa_HRuler.create(Maunaloa_ChartCollection.globalChartWidth)(response.minDx)(xaxis)(Maunaloa_Chart.padding)(incMonths(v.chartType));
...
(function($PS) {
  ...
  var reposIdFor = function (chartTypeId) {
      return function (ticker) {
          return ticker + (":" + Data_Number_Format.toString(Data_Int.toNumber(chartTypeId)));
      };
  };
          ...
          return function (ticker) {
              return function (dropAmt) {
                  return function (takeAmt) {
                      ...
                      var cachedResponse = Maunaloa_Repository.getJsonResponse(reposId);
