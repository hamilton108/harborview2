  ...
  var validateMaybe = function (desc) {
      return function (el) {
          if (el instanceof Data_Maybe.Nothing) {
              return $foreign.alert("ERROR!: " + desc);
          };
                  ...
                  return function __do() {
                      ...
                      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(fetchLevelLinesURL(ticker)))(function (res) {
                          if (res instanceof Data_Either.Left) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))($foreign.alert("Affjax Error: " + Affjax.printError(res.value0))));
                          };
                          if (res instanceof Data_Either.Right) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))($foreign.showJson(res.value0.body)))((function () {
          ...
          return function (chartLevel) {
              return function __do() {
                  ...
                  if (context instanceof Data_Maybe.Nothing) {
                      return Control_Apply.applySecond(Effect.applyEffect)($foreign.alert("ERROR! (initEvents) No getHtmlContext chartLevel!"))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))();
                  };
...
(function($PS) {
  ...
  var tmp = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 51, column 1 - line 51, column 19): " + [ v.constructor.name ]);
  };
