...
(function($PS) {
  ...
  var $foreign = $PS["Maunaloa.Common"];
  var Data_Int = $PS["Data.Int"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Show = $PS["Data.Show"];
  ...
  var MonthChart = (function () {
      ...
      MonthChart.value = new MonthChart();
      return MonthChart;
  })();
  ...
  var showUnixTime = {
      show: function (v) {
          return "(UnixTime " + (Data_Show.show(Data_Show.showNumber)(v) + ")");
      }
  };
  var showPix = {
      show: function (v) {
          return "(Pix " + (Data_Show.show(Data_Show.showNumber)(v) + ")");
      }
  };
  var showPadding = {
      show: function (v) {
          return "(Padding " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
          ...
          })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber))(Data_Show.showNumber))(Data_Show.showNumber)))(v) + ")");
      }
  };
  var showHtmlId = {
      show: function (v) {
  ...
  var showChartWidth = {
      show: function (v) {
          return "(ChartWidth: " + (Data_Show.show(Data_Show.showNumber)(v) + ")");
      }
  };
  var showChartHeight = {
      show: function (v) {
          return "(ChartHeight: " + (Data_Show.show(Data_Show.showNumber)(v) + ")");
      }
  };
  ...
  exports["WeekChart"] = WeekChart;
  exports["MonthChart"] = MonthChart;
  exports["asChartType"] = asChartType;
  exports["showPix"] = showPix;
  exports["showChartWidth"] = showChartWidth;
  exports["showChartHeight"] = showChartHeight;
  exports["showHtmlId"] = showHtmlId;
  exports["eqHtmlId"] = eqHtmlId;
  exports["showUnixTime"] = showUnixTime;
  exports["ordUnixTime"] = ordUnixTime;
  exports["eqValueRange"] = eqValueRange;
  exports["showPadding"] = showPadding;
...
(function($PS) {
  ...
  var showHRuler = {
      show: function (v) {
          return "(VRuler " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
              reflectSymbol: function () {
                  return "h";
              }
          })(Data_Show.showRecordFieldsCons({
          ...
          })(Data_Show.showRecordFieldsNil)(Maunaloa_Common.showChartWidth))(Maunaloa_Common.showPix))(Maunaloa_Common.showPadding))(Data_Show.showNumber))(Maunaloa_Common.showChartHeight)))(v) + ")");
      }
  };
...
(function($PS) {
  ...
  var showCandlestick = {
      show: function (v) {
          return "(Candlestick " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
              reflectSymbol: function () {
                  return "c";
              }
          })(Data_Show.showRecordFieldsCons({
  ...
  exports["paint"] = paint;
  exports["showCandlestick"] = showCandlestick;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Util.DateUtil"] = $PS["Util.DateUtil"] || {};
  var exports = $PS["Util.DateUtil"];
  var Data_Array = $PS["Data.Array"];
  var Data_Int = $PS["Data.Int"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Tuple = $PS["Data.Tuple"];
  ...
  var dateRangeOf = function (v) {
      return function (lx) {
          var lo = v + Maunaloa_Common.dayInMillis * Data_Int.toNumber(Data_Maybe.fromMaybe(0)(Data_Array.last(lx)));
          var hi = v + Maunaloa_Common.dayInMillis * Data_Int.toNumber(Data_Maybe.fromMaybe(0)(Data_Array.head(lx)));
          return new Data_Tuple.Tuple(lo, hi);
      };
  };
  exports["dateRangeOf"] = dateRangeOf;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  ...
  var Data_Show = $PS["Data.Show"];
  var Maunaloa_Common = $PS["Maunaloa.Common"];
  var Util_DateUtil = $PS["Util.DateUtil"];
  var timeStampToPix = function (v) {
      return function (v1) {
          var days = (v1 - v.startTime) / Maunaloa_Common.dayInMillis;
  ...
  var showHRuler = {
      show: function (v) {
          return "(HRuler " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
              reflectSymbol: function () {
                  return "endTime";
              }
          })(Data_Show.showRecordFieldsCons({
          ...
          })(Data_Show.showRecordFieldsNil)(Data_Show.showArray(Data_Show.showNumber)))(Maunaloa_Common.showUnixTime))(Maunaloa_Common.showPix))(Maunaloa_Common.showPadding))(Data_Show.showInt))(Maunaloa_Common.showUnixTime)))(v) + ")");
      }
  };
              ...
              return function ($copy_curLines) {
                  return function ($copy_curTime) {
                      ...
                      function $tco_loop(timestampFn, endTime, numMonths, curLines, curTime) {
                          ...
                          throw new Error("Failed pattern match at Maunaloa.HRuler (line 81, column 1 - line 81, column 108): " + [ timestampFn.constructor.name, endTime.constructor.name, numMonths.constructor.name, curLines.constructor.name, curTime.constructor.name ]);
                      };
                      while (!$tco_done) {
              ...
              return function (v) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.head(offsets))(function (offset0) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.last(offsets))(function (offsetN) {
                          var v1 = Util_DateUtil.dateRangeOf(minDx)(offsets);
                          var offsetBoundary = {
                              oHead: offset0,
                              oLast: offsetN
                          };
...
(function($PS) {
  ...
  var Maunaloa_VRuler = $PS["Maunaloa.VRuler"];
  var Chart = (function () {
      function Chart(value0) {
          this.value0 = value0;
      };
      Chart.create = function (value0) {
          return new Chart(value0);
      };
      return Chart;
  })();
  var EmptyChart = (function () {
      ...
      EmptyChart.value = new EmptyChart();
      return EmptyChart;
  })();
  var toRectangle = function (v) {
      ...
      throw new Error("Failed pattern match at Maunaloa.Chart (line 107, column 1 - line 107, column 41): " + [ v.constructor.name ]);
  };
  var showChart = {
      show: function (v) {
          if (v instanceof EmptyChart) {
          ...
          if (v instanceof Chart) {
              return "(Chart lines: " + (Data_Show.show(Data_Show.showArray(Data_Show.showArray(Data_Show.showNumber)))(v.value0.lines) + (", candlesticks: " + (Data_Show.show(Data_Show.showArray(Maunaloa_Candlestick.showCandlestick))(v.value0.candlesticks) + (", canvasId: " + (Data_Show.show(Maunaloa_Common.showHtmlId)(v.value0.canvasId) + (", vruler: " + (Data_Show.show(Maunaloa_VRuler.showHRuler)(v.value0.vruler) + (", w: " + (Data_Show.show(Maunaloa_Common.showChartWidth)(v.value0.w) + (", h: " + (Data_Show.show(Maunaloa_Common.showChartHeight)(v.value0.h) + (", chartLevel: " + (Data_Show.show(Data_Maybe.showMaybe(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                  reflectSymbol: function () {
                      return "addLevelId";
                  }
              })(Data_Show.showRecordFieldsCons({
              ...
              })(Data_Show.showRecordFieldsNil)(Maunaloa_Common.showHtmlId))(Maunaloa_Common.showHtmlId))(Maunaloa_Common.showHtmlId))))(v.value0.chartLevel) + ")")))))))))))));
          };
          throw new Error("Failed pattern match at Maunaloa.Chart (line 78, column 1 - line 88, column 54): " + [ v.constructor.name ]);
      }
  };
  var paint = function (v) {
      return function (v1) {
          if (v1 instanceof EmptyChart) {
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          };
          if (v1 instanceof Chart) {
              return function __do() {
                  var canvas = Graphics_Canvas.getCanvasElementById(v1.value0.canvasId)();
                  if (canvas instanceof Data_Maybe.Nothing) {
                      return Effect_Console.logShow(Data_Show.showString)("CanvasId " + (v1.value0.canvasId + " does not exist!"))();
                  };
                  if (canvas instanceof Data_Maybe.Just) {
                      var ctx = Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(Data_Show.showString)("Drawing canvas: " + v1.value0.canvasId))(Graphics_Canvas.getContext2D(canvas.value0))();
                      var r = toRectangle(v1);
                      return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Graphics_Canvas.clearRect(ctx)(r))(Maunaloa_VRuler.paint(v1.value0.vruler)(ctx)))(Maunaloa_HRuler.paint(v)(v1.value0.vruler.h)(ctx)))(Maunaloa_Line.paint(v)(v1.value0.lines)(ctx)))(Maunaloa_Candlestick.paint(v)(v1.value0.candlesticks)(ctx))();
                  };
                  throw new Error("Failed pattern match at Maunaloa.Chart (line 118, column 9 - line 131, column 55): " + [ canvas.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at Maunaloa.Chart (line 113, column 1 - line 113, column 42): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var padding = {
      left: 50.0,
...
(function($PS) {
  ...
  var StdLine = (function () {
      function StdLine(value0) {
          this.value0 = value0;
      };
      StdLine.create = function (value0) {
          return new StdLine(value0);
      };
      return StdLine;
  })();
  var RiscLine = (function () {
      function RiscLine(value0) {
          this.value0 = value0;
      };
      RiscLine.create = function (value0) {
          return new RiscLine(value0);
      };
      return RiscLine;
  })();
  var BreakEvenLine = (function () {
      function BreakEvenLine(value0) {
          this.value0 = value0;
      };
      BreakEvenLine.create = function (value0) {
          return new BreakEvenLine(value0);
      };
  ...
  var validateMaybe = function (desc) {
      return function (el) {
          if (el instanceof Data_Maybe.Nothing) {
              return Maunaloa_Common.alert("ERROR!: " + desc);
          };
          if (el instanceof Data_Maybe.Just) {
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 383, column 5 - line 385, column 28): " + [ el.constructor.name ]);
      };
  };
  ...
  var showLine = {
      show: function (v) {
          if (v instanceof StdLine) {
              return "StdLine: " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                  reflectSymbol: function () {
                      return "selected";
                  }
              })(Data_Show.showRecordFieldsCons({
          ...
          if (v instanceof RiscLine) {
              return "RiscLine: " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                  reflectSymbol: function () {
                      return "bid";
                  }
              })(Data_Show.showRecordFieldsCons({
          ...
          if (v instanceof BreakEvenLine) {
              return "BreakEvenLine: " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                  reflectSymbol: function () {
                      return "ask";
                  }
              })(Data_Show.showRecordFieldsCons({
  ...
  var optionPriceURL = function (ticker) {
      return function (curStockPrice) {
          return Maunaloa_Common.mainURL + ("/optionprice/" + (ticker + ("/" + Data_Number_Format.toStringWith(Data_Number_Format.fixed(2))(curStockPrice))));
      };
  };
  var initEvent = function (toListener) {
      return function (element) {
          return function (eventType) {
              return function __do() {
                  var e1 = Web_Event_EventTarget.eventListener(toListener)();
                  var info = {
                      target: element,
                      listener: e1,
                      eventType: eventType
                  };
                  return Control_Apply.applySecond(Effect.applyEffect)($foreign.addListener(info))(Web_Event_EventTarget.addEventListener(eventType)(e1)(false)(Web_DOM_Element.toEventTarget(element)))();
              };
          };
      };
  };
  var getHtmlContext1 = function (prm) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(prm.canvas)(function (canvas1) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(prm.add)(function (addLlBtn1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(prm.fetch)(function (fetchLlBtn1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(prm.ctx)(function (ctx1) {
                      return new Data_Maybe.Just({
                          canvasContext: ctx1,
  ...
  var getHtmlContext = function (v) {
      return function __do() {
          var doc = getDoc();
          var canvasElement = Web_DOM_NonElementParentNode.getElementById(v.levelCanvasId)(doc)();
          var addLevelId2 = Web_DOM_NonElementParentNode.getElementById(v.addLevelId)(doc)();
          var fetchLevelId2 = Web_DOM_NonElementParentNode.getElementById(v.fetchLevelId)(doc)();
          var canvas = Graphics_Canvas.getCanvasElementById(v.levelCanvasId)();
          return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(validateMaybe("canvasElement")(canvasElement))(validateMaybe("addLevelId2")(addLevelId2)))(validateMaybe("fetchLevelId2")(fetchLevelId2)))(validateMaybe("canvas")(canvas)))(Control_Applicative.pure(Effect.applicativeEffect)(getHtmlContext1({
      ...
      return function (curStockPrice) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(optionPriceURL(ticker)(curStockPrice)))(function (res) {
              if (res instanceof Data_Either.Left) {
                  return Control_Apply.applySecond(Effect_Aff.applyAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Maunaloa_Common.alert("Affjax Error: " + Affjax.printError(res.value0))))(Control_Applicative.pure(Effect_Aff.applicativeAff)(-1.0));
              };
              if (res instanceof Data_Either.Right) {
                  var result = updOptionPriceFromJson(res.value0.body);
                  if (result instanceof Data_Either.Left) {
                      return Control_Apply.applySecond(Effect_Aff.applyAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Maunaloa_Common.alert(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(result.value0))))(Control_Applicative.pure(Effect_Aff.applicativeAff)(-1.0));
                  };
                  if (result instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(result.value0.value);
                  };
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 316, column 17 - line 321, column 43): " + [ result.constructor.name ]);
              };
              throw new Error("Failed pattern match at Maunaloa.LevelLine (line 308, column 9 - line 321, column 43): " + [ res.constructor.name ]);
          });
      };
  };
  ...
  var handleMouseEventUpLine = function (vr) {
      return function (line) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 339, column 5 - line 343, column 45): " + [ line.constructor.name ]);
      };
  };
  ...
  var fetchLevelLineButtonClick = function (ticker) {
      return function (ce) {
          return function (evt) {
              return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(Maunaloa_Common.mainURL + "/days/1"))(function (res) {
                  if (res instanceof Data_Either.Left) {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Maunaloa_Common.alert("Affjax Error: " + Affjax.printError(res.value0))));
                  };
                  if (res instanceof Data_Either.Right) {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Maunaloa_Common.alert("OK!"));
                  };
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 257, column 9 - line 264, column 41): " + [ res.constructor.name ]);
              }));
          };
      };
  };
  var mouseEventDown = function (evt) {
      return Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))($foreign.onMouseDown(evt));
  };
  var mouseEventDrag = function (evt) {
      return Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))($foreign.onMouseDrag(evt));
  };
  ...
  exports["clear"] = clear;
  exports["StdLine"] = StdLine;
  exports["RiscLine"] = RiscLine;
  exports["BreakEvenLine"] = BreakEvenLine;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  ...
  var showChartCollection = {
      show: function (v) {
          return "(ChartCollection " + (Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
              reflectSymbol: function () {
                  return "charts";
              }
          })(Data_Show.showRecordFieldsCons({
          ...
          })(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Maunaloa_HRuler.showHRuler))(Data_Show.showArray(Maunaloa_Chart.showChart))))(v) + ")");
      }
  };
  var mappingToChartLevel = function (v) {
      var $8 = Data_String_CodePoints.length(v.levelCanvasId) === 0;
      if ($8) {
          return Data_Maybe.Nothing.value;
      };
      return new Data_Maybe.Just({
  ...
  var findChartPredicate = function (v) {
      if (v instanceof Maunaloa_Chart.EmptyChart) {
          return false;
      };
      if (v instanceof Maunaloa_Chart.Chart) {
          return Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
              reflectSymbol: function () {
                  return "levelCanvasId";
              }
          })(Maunaloa_Common.eqHtmlId))()({
              reflectSymbol: function () {
                  return "fetchLevelId";
              }
          })(Maunaloa_Common.eqHtmlId))()({
          ...
          })(Maunaloa_Common.eqHtmlId))))(v.value0.chartLevel)(Data_Maybe.Nothing.value);
      };
      throw new Error("Failed pattern match at Maunaloa.ChartCollection (line 74, column 1 - line 74, column 41): " + [ v.constructor.name ]);
  };
  var levelLines = function (ticker) {
      return function (charts) {
          var levelLine = Data_Array.find(findChartPredicate)(charts);
          if (levelLine instanceof Data_Maybe.Nothing) {
              return Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(Data_Show.showString)("ERROR! (levelLines) No levelLine!"))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
          };
          if (levelLine instanceof Data_Maybe.Just && levelLine.value0 instanceof Maunaloa_Chart.EmptyChart) {
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          };
          if (levelLine instanceof Data_Maybe.Just && levelLine.value0 instanceof Maunaloa_Chart.Chart) {
              var caid = Data_Maybe.fromJust()(levelLine.value0.value0.chartLevel);
              return Maunaloa_LevelLine.initEvents(ticker)(levelLine.value0.value0.vruler)(caid);
          };
          throw new Error("Failed pattern match at Maunaloa.ChartCollection (line 89, column 5 - line 99, column 63): " + [ levelLine.constructor.name ]);
      };
  };
  var paint = function (v) {
      var paint_ = Maunaloa_Chart.paint(v.hruler);
      return Control_Apply.applySecond(Effect.applyEffect)(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(paint_)(v.charts))(levelLines(v.ticker)(v.charts));
  };
  var paintAff = function (coll) {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(paint(coll));
  };
  exports["globalChartWidth"] = globalChartWidth;
  exports["mappingToChartLevel"] = mappingToChartLevel;
  exports["paintAff"] = paintAff;
  exports["showChartCollection"] = showChartCollection;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Maunaloa.ChartTransform"] = $PS["Maunaloa.ChartTransform"] || {};
  var exports = $PS["Maunaloa.ChartTransform"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var transformMapping1 = function (v) {
      return function (ec) {
          var vr = Maunaloa_Chart.vruler(ec.valueRange)(Maunaloa_ChartCollection.globalChartWidth)(v.chartHeight);
          var linesToPix = Data_Functor.map(Data_Functor.functorArray)(Maunaloa_Line.lineToPix(vr))(ec.lines);
          var cndlToPix = Data_Functor.map(Data_Functor.functorArray)(Maunaloa_Candlestick.candleToPix(vr))(ec.candlesticks);
          var clevel = Maunaloa_ChartCollection.mappingToChartLevel(v);
          return new Maunaloa_Chart.Chart({
              lines: linesToPix,
              candlesticks: cndlToPix,
              canvasId: v.canvasId,
              vruler: vr,
              w: Maunaloa_ChartCollection.globalChartWidth,
              h: v.chartHeight,
              chartLevel: clevel
          });
      };
  ...
  var slice = function (v) {
      return function (v1) {
          return function (vals) {
              var $18 = v === 0;
              if ($18) {
                  return Data_Array.take(v1)(vals);
              };
              return Data_Array.take(v1)(Data_Array.drop(v)(vals));
          };
      };
  };
  var nullValueRange = {
  ...
  var minMaxRanges = function (v) {
      return function (vals) {
          var mmas = Data_Functor.map(Data_Functor.functorArray)(function (y) {
              return Data_Maybe.fromMaybe(nullValueRange)(y);
          })(Data_Array.filter(function (x) {
              return Data_Eq.notEq(Data_Maybe.eqMaybe(Maunaloa_Common.eqValueRange))(x)(Data_Maybe.Nothing.value);
          })(vals));
          var result = Data_Maybe.fromMaybe(nullValueRange)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.minimumBy(Data_Foldable.foldableArray)(function (v1) {
              return function (v2) {
                  var $23 = v1.minVal < v2.minVal;
                  if ($23) {
              ...
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.maximumBy(Data_Foldable.foldableArray)(function (v1) {
                  return function (v2) {
                      var $26 = v1.maxVal > v2.maxVal;
                      if ($26) {
                          return Data_Ordering.GT.value;
                      };
                      return Data_Ordering.LT.value;
  ...
  var minMaxCndl = function (cndl) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.minimumBy(Data_Foldable.foldableArray)(function (x) {
          return function (y) {
              var $29 = x.l < y.l;
              if ($29) {
                  return Data_Ordering.LT.value;
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.maximumBy(Data_Foldable.foldableArray)(function (x) {
              return function (y) {
                  var $30 = x.h > y.h;
                  if ($30) {
                      return Data_Ordering.GT.value;
  ...
  var minMaxArray = function (ar) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.minimum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(ar))(function (mib) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.maximum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(ar))(function (mab) {
              return Data_Maybe.Just.create({
                  minVal: mib,
                  maxVal: mab
              });
  ...
  var normalizeLine = function (line) {
      var v = Data_Maybe.fromMaybe(Maunaloa_Common.valueRange(-1.0)(1.0))(minMaxArray(line));
      var scalingFactor = Data_Ord.max(Data_Ord.ordNumber)(Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(v.minVal))(v.maxVal);
      var scalingFn = function (x) {
          return x / scalingFactor;
      };
      return Data_Functor.map(Data_Functor.functorArray)(scalingFn)(line);
  };
  var chartValueRange = function (lx) {
      return function (bars) {
          return function (cx) {
              return function (scaling) {
                  var minMaxLines = Data_Functor.map(Data_Functor.functorArray)(minMaxArray)(lx);
                  var minMaxCandlesticks = minMaxCndl(cx);
                  var minMaxBars = Data_Functor.map(Data_Functor.functorArray)(minMaxArray)(bars);
                  var allVr = Data_Array.cons(minMaxCandlesticks)(Data_Array.concat([ minMaxLines, minMaxBars ]));
              ...
              return function (scaling) {
                  return function (doNormalizeLines) {
                      return function (numVlines) {
                          var lines_ = (function () {
                              var tmp = Data_Functor.map(Data_Functor.functorArray)(slice(dropAmt)(takeAmt))(Data_Maybe.fromMaybe([  ])(c.lines));
                              var $33 = doNormalizeLines === true;
                              if ($33) {
                                  return Data_Functor.map(Data_Functor.functorArray)(normalizeLine)(tmp);
                              };
                              return tmp;
                          })();
                          var cndl_ = slice(dropAmt)(takeAmt)(Data_Maybe.fromMaybe([  ])(c.candlesticks));
                          var bars_ = Data_Functor.map(Data_Functor.functorArray)(slice(dropAmt)(takeAmt))(Data_Maybe.fromMaybe([  ])(c.bars));
                          var valueRange = chartValueRange(lines_)(bars_)(cndl_)(scaling);
                          return {
                              lines: lines_,
                              bars: bars_,
                              candlesticks: cndl_,
      ...
      return function (takeAmt) {
          return function (response) {
              return function (v) {
                  ...
                  if (v.chartId === "chart2") {
                      var cw = chartWindow(dropAmt)(takeAmt)(response.chart2)(1.0)(true)(10);
                      return transformMapping1(v)(cw);
                  };
                  if (v.chartId === "chart3") {
                      var cw = chartWindow(dropAmt)(takeAmt)(response.chart3)(1.0)(false)(10);
                      return transformMapping1(v)(cw);
                  };
                  return Maunaloa_Chart.EmptyChart.value;
              };
          };
      };
  };
  var transform = function (response) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Data_Identity.monadIdentity)))(function (v) {
          var xaxis = slice(v.dropAmt)(v.takeAmt)(response.xAxis);
          var ruler = Maunaloa_HRuler.create(Maunaloa_ChartCollection.globalChartWidth)(response.minDx)(xaxis)(Maunaloa_Chart.padding);
          var ruler1 = Data_Maybe.fromJust()(ruler);
          var charts1 = Data_Functor.map(Data_Functor.functorArray)(transformMapping(v.dropAmt)(v.takeAmt)(response))(v.mappings);
          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Data_Identity.applicativeIdentity))({
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Maunaloa.MaunaloaError"] = $PS["Maunaloa.MaunaloaError"] || {};
  var exports = $PS["Maunaloa.MaunaloaError"];
  var Data_Show = $PS["Data.Show"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Console = $PS["Effect.Console"];                
  ...
  var handleErrorAff = function (v) {
      if (v instanceof AffjaxError) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(Data_Show.showString)("AffjaxError: " + v.value0));
      };
      if (v instanceof JsonError) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(Data_Show.showString)("JsonError: " + v.value0));
      };
      throw new Error("Failed pattern match at Maunaloa.MaunaloaError (line 20, column 1 - line 20, column 44): " + [ v.constructor.name ]);
  };
  exports["AffjaxError"] = AffjaxError;
  exports["JsonError"] = JsonError;
  exports["handleErrorAff"] = handleErrorAff;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Maunaloa.Json.JsonCharts"] = $PS["Maunaloa.Json.JsonCharts"] || {};
  var exports = $PS["Maunaloa.Json.JsonCharts"];
  var Affjax = $PS["Affjax"];
  var Affjax_ResponseFormat = $PS["Affjax.ResponseFormat"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Maunaloa_Common = $PS["Maunaloa.Common"];
  var Maunaloa_MaunaloaError = $PS["Maunaloa.MaunaloaError"];
  var chartsFromJson = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldMaybe(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonNumber))))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldMaybe(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
      reflectSymbol: function () {
          return "o";
      }
  })()())({
  ...
  })()())())))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldMaybe(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonNumber))))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
      reflectSymbol: function () {
          return "lines";
      }
  })()())({
  ...
  })()())()))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonInt)))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
      reflectSymbol: function () {
          return "xAxis";
      }
  })()())({
  ...
  var chartUrl = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Maunaloa.Json.JsonCharts (line 80, column 1 - line 80, column 39): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var fetchCharts = function (ticker) {
      return function (chartType) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(chartUrl(chartType)(ticker)))(function (res) {
              if (res instanceof Data_Either.Left) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create(new Maunaloa_MaunaloaError.AffjaxError(Affjax.printError(res.value0))));
              };
              if (res instanceof Data_Either.Right) {
                  var charts = chartsFromJson(res.value0.body);
                  if (charts instanceof Data_Either.Left) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create(new Maunaloa_MaunaloaError.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(charts.value0))));
                  };
                  if (charts instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Right(charts.value0));
                  };
                  throw new Error("Failed pattern match at Maunaloa.Json.JsonCharts (line 98, column 17 - line 102, column 45): " + [ charts.constructor.name ]);
              };
              throw new Error("Failed pattern match at Maunaloa.Json.JsonCharts (line 91, column 9 - line 102, column 45): " + [ res.constructor.name ]);
          });
      };
  };
  exports["fetchCharts"] = fetchCharts;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  ...
  var Effect_Console = $PS["Effect.Console"];
  var Maunaloa_ChartCollection = $PS["Maunaloa.ChartCollection"];
  var Maunaloa_ChartTransform = $PS["Maunaloa.ChartTransform"];
  var Maunaloa_Common = $PS["Maunaloa.Common"];
  var Maunaloa_Json_JsonCharts = $PS["Maunaloa.Json.JsonCharts"];
  var Maunaloa_LevelLine = $PS["Maunaloa.LevelLine"];
  var Maunaloa_MaunaloaError = $PS["Maunaloa.MaunaloaError"];                
  var tmp = function (v) {
      if (v instanceof Maunaloa_LevelLine.StdLine) {
          return 1;
      };
      if (v instanceof Maunaloa_LevelLine.RiscLine) {
          return 2;
      };
      if (v instanceof Maunaloa_LevelLine.BreakEvenLine) {
          return 3;
      };
      throw new Error("Failed pattern match at Main (line 84, column 1 - line 84, column 19): " + [ v.constructor.name ]);
  };
  ...
  var paint = function (chartTypeId) {
      return function (mappings) {
          return function (ticker) {
              return function (dropAmt) {
                  return function (takeAmt) {
                      var curChartType = Maunaloa_Common.asChartType(chartTypeId);
                      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Maunaloa_Json_JsonCharts.fetchCharts(ticker)(curChartType))(function (charts) {
                          if (charts instanceof Data_Either.Left) {
                              return Maunaloa_MaunaloaError.handleErrorAff(charts.value0);
                          };
                          if (charts instanceof Data_Either.Right) {
                              ...
                              return Control_Apply.applySecond(Effect_Aff.applyAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(Maunaloa_ChartCollection.showChartCollection)(collection)))(Maunaloa_ChartCollection.paintAff(collection));
                          };
                          throw new Error("Failed pattern match at Main (line 68, column 13 - line 77, column 40): " + [ charts.constructor.name ]);
                      }));
                  };
              };
          };
  ...
  exports["paint"] = paint;
  exports["clearLevelLines"] = clearLevelLines;
  exports["tmp"] = tmp;
})(PS);
