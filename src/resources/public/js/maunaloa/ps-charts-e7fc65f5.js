...
(function($PS) {
  ...
  var eqPix = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  var eqPadding = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.bottom === y.bottom && x.left === y.left && x.right === y.right && x.top === y.top;
      };
  });
  var eqHtmlId = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  var eqChartWidth = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  var eqChartHeight = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  ...
  exports["eqPix"] = eqPix;
  exports["eqChartWidth"] = eqChartWidth;
  exports["eqChartHeight"] = eqChartHeight;
  exports["eqHtmlId"] = eqHtmlId;
  exports["ordUnixTime"] = ordUnixTime;
  exports["eqPadding"] = eqPadding;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  ...
  var eqVRuler = new Data_Eq.Eq(function (x) {
      return function (y) {
          return Data_Eq.eq(Maunaloa_Common.eqChartHeight)(x.h)(y.h) && x.maxVal === y.maxVal && Data_Eq.eq(Maunaloa_Common.eqPadding)(x.padding)(y.padding) && Data_Eq.eq(Maunaloa_Common.eqPix)(x.ppy)(y.ppy) && Data_Eq.eq(Maunaloa_Common.eqChartWidth)(x.w)(y.w);
      };
  });
...
(function($PS) {
  ...
  var eqCandlestick = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.c === y.c && x.h === y.h && x.l === y.l && x.o === y.o;
      };
  });
  ...
  exports["paint"] = paint;
  exports["eqCandlestick"] = eqCandlestick;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var paint = function (hruler) {
      return function (v) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Maunaloa.Chart (line 90, column 9 - line 103, column 55): " + [ canvas.constructor.name ]);
          };
      };
  };
  var padding = {
  ...
  var eqChart = new Data_Eq.Eq(function (x) {
      return function (y) {
          return Data_Eq.eq(Data_Eq.eqArray(Maunaloa_Candlestick.eqCandlestick))(x.candlesticks)(y.candlesticks) && Data_Eq.eq(Maunaloa_Common.eqHtmlId)(x.canvasId)(y.canvasId) && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "levelCanvasId";
          }))(Maunaloa_Common.eqHtmlId))()(new Data_Symbol.IsSymbol(function () {
              return "fetchLevelId";
          }))(Maunaloa_Common.eqHtmlId))()(new Data_Symbol.IsSymbol(function () {
              return "addLevelId";
          }))(Maunaloa_Common.eqHtmlId))))(x.chartLevel)(y.chartLevel) && Data_Eq.eq(Maunaloa_Common.eqChartHeight)(x.h)(y.h) && Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqArray(Data_Eq.eqNumber)))(x.lines)(y.lines) && Data_Eq.eq(Maunaloa_VRuler.eqVRuler)(x.vruler)(y.vruler) && Data_Eq.eq(Maunaloa_Common.eqChartWidth)(x.w)(y.w);
      };
  });
...
(function($PS) {
  ...
  var validateMaybe = function (desc) {
      return function (el) {
          if (el instanceof Data_Maybe.Nothing) {
              return Effect_Console.logShow(Data_Show.showString)("ERROR!: " + desc);
          };
          if (el instanceof Data_Maybe.Just) {
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 282, column 5 - line 284, column 28): " + [ el.constructor.name ]);
      };
  };
  ...
  var unlistener = function (elr) {
      return function (dummy) {
          return function __do() {
              var elrx = Effect_Ref.read(elr)();
              return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(unlisten)(elrx)();
          };
      };
  }; 
  var showLine = new Data_Show.Show(function (v) {
      return "Line: " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "draggable";
          ...
          return "y";
      }))(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showString))(Data_Show.showBoolean))(Data_Show.showBoolean))(Data_Show.showBoolean)))(v);
  });
  var optionPriceURL = "http://172.17.0.2:3000/optionprice/3/2";
  var initLines = {
      lines: [  ],
      pilotLine: Data_Maybe.Nothing.value
  };
  var linesRef = Effect_Ref["new"](initLines);
  var handleRiscLine = function (v) {
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(optionPriceURL))(function (res) {
          if (res instanceof Data_Either.Left) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(Data_Show.showString)("Affjax Error: " + Affjax.printError(res.value0)));
          };
          if (res instanceof Data_Either.Right) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)($foreign.showJson(res.value0.body));
          };
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 241, column 9 - line 249, column 18): " + [ res.constructor.name ]);
      }));
  };
  var getHtmlContext1 = function (canvas) {
      return function (addLlBtn) {
          return function (fetchLlBtn) {
              return function (ctx) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(canvas)(function (canvas1) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(addLlBtn)(function (addLlBtn1) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(fetchLlBtn)(function (fetchLlBtn1) {
                              return Control_Bind.bind(Data_Maybe.bindMaybe)(ctx)(function (ctx1) {
                                  return new Data_Maybe.Just({
                                      canvasContext: ctx1,
  ...
  var getHtmlContext = function (v) {
      return function __do() {
          ...
          return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(validateMaybe("canvasElement")(canvasElement))(validateMaybe("addLevelId2")(addLevelId2)))(validateMaybe("fetchLevelId2")(fetchLevelId2)))(validateMaybe("canvas")(canvas)))(Control_Applicative.pure(Effect.applicativeEffect)(getHtmlContext1(canvasElement)(addLevelId2)(fetchLevelId2)(canvas)))();
      };
  };
  var fetchLevelLinesURL = function (ticker) {
      return "http://172.17.0.2:3000/risclines/" + ticker;
  };
  var eventListenerRef = Effect_Ref["new"]([  ]);
  var eqPilotLine = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.strokeStyle === y.strokeStyle && x.y === y.y;
      };
  });
  var hasPilotLine = function (v) {
      return Data_Eq.notEq(Data_Maybe.eqMaybe(eqPilotLine))(v.pilotLine)(Data_Maybe.Nothing.value);
  };
  ...
  var mouseEventDown = function (lref) {
      return function (evt) {
          return function __do() {
              var lxx = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Effect_Ref.read(lref))();
              return $foreign.onMouseDown(evt)(lxx)();
          };
      };
  };
  var mouseEventDrag = function (lref) {
      return function (ce) {
          return function (vruler) {
              return function (evt) {
                  return function __do() {
                      var lxx = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Effect_Ref.read(lref))();
                      var $40 = hasPilotLine(lxx);
                      if ($40) {
                          var ctx = Graphics_Canvas.getContext2D(ce)();
                          return $foreign.onMouseDrag(evt)(lxx)(ctx)(vruler)();
                      };
  ...
  var checkIfRiscLine = function (v) {
      if (v.riscLine) {
          return handleRiscLine(v);
      };
      if (!v.riscLine) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
      };
      throw new Error("Failed pattern match at Maunaloa.LevelLine (line 253, column 5 - line 257, column 22): " + [ v.riscLine.constructor.name ]);
  };
  var mouseEventUp = function (lref) {
      return function (ce) {
          return function (vruler) {
              return function (evt) {
                  return function __do() {
                      var lxx = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Effect_Ref.read(lref))();
                      var selectedLine = $foreign.onMouseUp(evt)(lxx)();
                      return Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(showLine)(selectedLine))(checkIfRiscLine(selectedLine))();
                  };
              };
          };
      };
  ...
  var addLine = function (newLine) {
      return function (v) {
          return Lines({
              lines: Data_Array.cons(newLine)(v.lines),
              pilotLine: v.pilotLine
          });
      };
  };
  var addRiscLevelLines = function (json) {
      return function (lref) {
          return function (ce) {
              return function (vruler) {
                  return function __do() {
                      var ctx = Control_Apply.applySecond(Effect.applyEffect)(Effect_Ref.modify_(function (v) {
                          return initLines;
                      })(lref))(Graphics_Canvas.getContext2D(ce))();
                      var newLines = Control_Apply.applySecond(Effect.applyEffect)($foreign.redraw(ctx)(vruler))($foreign.createRiscLines(json)(ctx)(vruler))();
                      return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (newLine) {
                          return Effect_Ref.modify_(addLine(newLine))(lref);
                      })(newLines)();
                  };
              };
          };
  ...
  var fetchLevelLineButtonClick = function (ticker) {
      return function (lref) {
          return function (ce) {
              return function (vruler) {
                  return function (evt) {
                      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(fetchLevelLinesURL(ticker)))(function (res) {
                          if (res instanceof Data_Either.Left) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Effect_Console.logShow(Data_Show.showString)("Affjax Error: " + Affjax.printError(res.value0))));
                          };
                          if (res instanceof Data_Either.Right) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(addRiscLevelLines(res.value0.body)(lref)(ce)(vruler)));
                          };
                          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 199, column 9 - line 214, column 18): " + [ res.constructor.name ]);
                      }));
                  };
              };
          };
  ...
  var addLevelLineButtonClick = function (lref) {
      return function (ce) {
          return function (vruler) {
              return function (evt) {
                  return function __do() {
                      var ctx = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Graphics_Canvas.getContext2D(ce))();
                      var newLine = $foreign.createLine(ctx)(vruler)();
                      return Effect_Ref.modify_(addLine(newLine))(lref)();
                  };
              };
          };
  ...
  var addEventListenerRef = function (lref) {
      return function (listener) {
          return Effect_Ref.modify_(function (listeners) {
              return Data_Array.cons(listener)(listeners);
          })(lref);
      };
  };
          ...
          return function (eventType) {
              return function (ref) {
                  return function __do() {
                      ...
                      return Control_Apply.applySecond(Effect.applyEffect)(Web_Event_EventTarget.addEventListener(eventType)(e1)(false)(Web_DOM_Element.toEventTarget(element)))(addEventListenerRef(ref)(info))();
                  };
              };
          };
      };
  ...
  var initEvents = function (ticker) {
      return function (vruler) {
          return function (chartLevel) {
              return function __do() {
                  var context = getHtmlContext(chartLevel)();
                  if (context instanceof Data_Maybe.Nothing) {
                      return Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(Data_Show.showString)("ERROR! (initEvents) No getHtmlContext chartLevel!"))(Control_Applicative.pure(Effect.applicativeEffect)(function (t) {
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                      }))();
                  };
                  if (context instanceof Data_Maybe.Just) {
                      ...
                      var lir = linesRef();
                      return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)($foreign.redraw(ctx)(vruler))(initEvent(addLevelLineButtonClick(lir)(context.value0.canvasContext)(vruler))(context.value0.addLevelLineBtn)("click")(elr)))(initEvent(fetchLevelLineButtonClick(ticker)(lir)(context.value0.canvasContext)(vruler))(context.value0.fetchLevelLinesBtn)("click")(elr)))(initEvent(mouseEventDown(lir))(context.value0.canvasElement)("mousedown")(elr)))(initEvent(mouseEventDrag(lir)(context.value0.canvasContext)(vruler))(context.value0.canvasElement)("mousemove")(elr)))(initEvent(mouseEventUp(lir)(context.value0.canvasContext)(vruler))(context.value0.canvasElement)("mouseup")(elr)))(Control_Applicative.pure(Effect.applicativeEffect)(unlistener(elr)))();
                  };
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 312, column 9 - line 329, column 42): " + [ context.constructor.name ]);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var mappingToChartLevel = function (v) {
      var $10 = Data_String_CodePoints.length(v.levelCanvasId) === 0;
      if ($10) {
          return Data_Maybe.Nothing.value;
      };
      return new Data_Maybe.Just({
  ...
  var findChartPredicate = function (v) {
      return Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          return "levelCanvasId";
      }))(Maunaloa_Common.eqHtmlId))()(new Data_Symbol.IsSymbol(function () {
          return "fetchLevelId";
      }))(Maunaloa_Common.eqHtmlId))()(new Data_Symbol.IsSymbol(function () {
          return "addLevelId";
      }))(Maunaloa_Common.eqHtmlId))))(v.chartLevel)(Data_Maybe.Nothing.value);
  };
  var levelLines = function (ticker) {
      return function (charts) {
          var levelLine = Data_Foldable.find(Data_Foldable.foldableArray)(findChartPredicate)(charts);
          if (levelLine instanceof Data_Maybe.Nothing) {
              return Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(Data_Show.showString)("ERROR! (levelLines) No levelLine!"))(Control_Applicative.pure(Effect.applicativeEffect)(function (t) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              }));
          };
          if (levelLine instanceof Data_Maybe.Just) {
              var caid = Data_Maybe.fromJust()(levelLine.value0.chartLevel);
              return Maunaloa_LevelLine.initEvents(ticker)(levelLine.value0.vruler)(caid);
          };
          throw new Error("Failed pattern match at Maunaloa.ChartCollection (line 82, column 5 - line 90, column 63): " + [ levelLine.constructor.name ]);
      };
  };
  var paint = function (v) {
...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["Maunaloa.Elm"] = $PS["Maunaloa.Elm"] || {};
  var exports = $PS["Maunaloa.Elm"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var transformMapping1 = function (v) {
      return function (elmChart) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(elmChart)(function (ec) {
              var range = Maunaloa_Chart.valueRangeFor(ec.valueRange);
              var vr = Maunaloa_Chart.vruler(range)(Maunaloa_ChartCollection.globalChartWidth)(v.chartHeight);
  ...
  var transformMapping = function (ciwin) {
      return function (v) {
          if (v.chartId === "chart") {
              return transformMapping1(v)(new Data_Maybe.Just(ciwin.chart));
          };
          if (v.chartId === "chart2") {
              return transformMapping1(v)(Data_Nullable.toMaybe(ciwin.chart2));
          };
          if (v.chartId === "chart3") {
              return transformMapping1(v)(Data_Nullable.toMaybe(ciwin.chart3));
          };
          return Data_Maybe.Nothing.value;
      };
  };
  var transform = function (mappings) {
      return function (ciwin) {
          var ruler = Maunaloa_HRuler.create(Maunaloa_ChartCollection.globalChartWidth)(ciwin.startdate)(ciwin.xaxis)(Maunaloa_Chart.padding);
          var ruler1 = Data_Maybe.fromJust()(ruler);
          var maybeCharts = Data_Array.filter(function (c) {
              return Data_Eq.notEq(Data_Maybe.eqMaybe(Maunaloa_Chart.eqChart))(c)(Data_Maybe.Nothing.value);
          })(Data_Functor.map(Data_Functor.functorArray)(transformMapping(ciwin))(mappings));
          var charts1 = Data_Functor.map(Data_Functor.functorArray)(Data_Maybe.fromJust())(maybeCharts);
          return {
              ticker: ciwin.ticker,
              charts: charts1,
              hruler: ruler1
...
(function($PS) {
  ...
  var exports = $PS["Main"];
  var Maunaloa_ChartCollection = $PS["Maunaloa.ChartCollection"];
  var Maunaloa_Elm = $PS["Maunaloa.Elm"];                
