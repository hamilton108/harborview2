...
(function($PS) {
  ...
  var validateMaybe = function (desc) {
      return function (el) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 302, column 5 - line 304, column 28): " + [ el.constructor.name ]);
      };
  }; 
          ...
          return function (vruler) {
              return function (evt) {
                  return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(fetchLevelLinesURL(ticker)))(function (res) {
                      ...
                      throw new Error("Failed pattern match at Maunaloa.LevelLine (line 210, column 9 - line 225, column 18): " + [ res.constructor.name ]);
                  }));
              };
          };
      };
  ...
  var mouseEventDrag = function (ce) {
      return function (vruler) {
          return function (evt) {
              return defaultEventHandling(evt);
          };
      };
  };
      ...
      return function (vruler) {
          return function (chartLevel) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 332, column 9 - line 346, column 100): " + [ context.constructor.name ]);
              };
          };
      };
  };
