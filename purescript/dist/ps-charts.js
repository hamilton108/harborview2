...
(function($PS) {
  ...
  var validateMaybe = function (desc) {
      return function (el) {
          ...
          throw new Error("Failed pattern match at Maunaloa.LevelLine (line 280, column 5 - line 282, column 28): " + [ el.constructor.name ]);
      };
  };
              ...
              return function (evt) {
                  return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(fetchLevelLinesURL(ticker)))(function (res) {
                      ...
                      if (res instanceof Data_Either.Right) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(defaultEventHandling(evt));
                      };
                      throw new Error("Failed pattern match at Maunaloa.LevelLine (line 206, column 9 - line 221, column 18): " + [ res.constructor.name ]);
                  }));
              };
          };
      };
  ...
  var mouseEventDrag = function (ce) {
      return function (vruler) {
          return function (evt) {
              return function __do() {
                  var hasPilot = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))($foreign.hasPilotLine)();
                  var $39 = hasPilot === true;
                  if ($39) {
                      var ctx = Graphics_Canvas.getContext2D(ce)();
                      return $foreign.onMouseDrag(evt)(ctx)(vruler)();
                  };
  ...
  var mouseEventUp = function (ce) {
      return function (vruler) {
          return function (evt) {
              return Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))($foreign.onMouseUp(evt));
          };
      };
  };
  var addLevelLineButtonClick = function (ce) {
      return function (vruler) {
          return function (evt) {
              return function __do() {
                  var ctx = Control_Apply.applySecond(Effect.applyEffect)(defaultEventHandling(evt))(Graphics_Canvas.getContext2D(ce))();
                  return $foreign.createLine(ctx)(vruler)();
              };
          };
      };
  };
          ...
          return function (chartLevel) {
              return function __do() {
                  ...
                  if (context instanceof Data_Maybe.Nothing) {
                      return Control_Apply.applySecond(Effect.applyEffect)(Effect_Console.logShow(Data_Show.showString)("ERROR! (initEvents) No getHtmlContext chartLevel!"))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))();
                  };
                  if (context instanceof Data_Maybe.Just) {
                      var ctx = Graphics_Canvas.getContext2D(context.value0.canvasContext)();
                      return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)($foreign.redraw(ctx)(vruler))(initEvent(addLevelLineButtonClick(context.value0.canvasContext)(vruler))(context.value0.addLevelLineBtn)("click")))(initEvent(fetchLevelLineButtonClick(ticker)(context.value0.canvasContext)(vruler))(context.value0.fetchLevelLinesBtn)("click")))(initEvent(mouseEventDown)(context.value0.canvasElement)("mousedown")))(initEvent(mouseEventDrag(context.value0.canvasContext)(vruler))(context.value0.canvasElement)("mousemove")))(initEvent(mouseEventUp(context.value0.canvasContext)(vruler))(context.value0.canvasElement)("mouseup"))();
                  };
                  throw new Error("Failed pattern match at Maunaloa.LevelLine (line 311, column 9 - line 325, column 100): " + [ context.constructor.name ]);
              };
          };
      };
  };
